                ...
                <div className="flex flex-col justify-center items-center h-full p-3">
                  <div className="text-center">
                    ...
                    <p className="text-xs text-gray-500 mb-1">
                      Deleting <span className="font-semibold" style={{ maxWidth: '120px', display: 'inline-block', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', verticalAlign: 'bottom' }}>{workflow.name}</span> cannot be undone, are you sure?
                    </p>
                    ...
                    {editingWorkflowId !== workflow.id && (
                      <div className="flex items-center space-x-1 opacity-0 group-hover:opacity-100 transition-opacity self-start">
                        <button
                          ...
                          title={workflow.isRunning ? 'Stop Workflow' : 'Run Workflow'}
                        >
                          {workflow.isRunning ? (
